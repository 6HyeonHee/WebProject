...
public class FreeWriteCtrl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		req.getRequestDispatcher("/binggrae/freeboard-write.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
        ...
        if (dto.getTitle() == null || dto.getTitle().isEmpty() || 
            ...
            JSFunction2.alertLocation(resp, "제목과 내용을 모두 입력해주세요.", "../freeboard/write.do");
            return;
        }
		...
		if (result == 1) {
			...
			JSFunction2.alertLocation(resp, "글쓰기에 실패했습니다.", "../freeboard/write.do");
		}
	}
