...
/*
 ...
 요청을 받아 처리한다.
 */
@WebServlet("/feeboard/UploadProcess.do")
/*
...
public class UploadProcess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		try {
			...
			String saveDirectory = getServletContext().getRealPath("/binggrae/Uploads");
			// 파일 업로드 처리
			...
			req.getRequestDispatcher("../freeboard/write.do").forward(req, resp);
		}
	}
}
