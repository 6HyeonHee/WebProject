              ...
              <div class="board_write_wrap ">
                <table>
                  ...
                  <tbody>
                    <tr>
                      <th>*제목</th>
                      <td><input type="text" name="title" class="size4" value="${ dto.title }"></td>
                    </tr>
                    <tr>
                      <th>*내용</th>
                      <td><textarea rows="10" name="content" placeholder="주민등록번호 등의 개인정보는 절대 노출하지마세요.">${ dto.content }</textarea></td>
                    </tr>
                    <tr>
